function ModalConfirmDelete(props) {
    return (
        <div className='fixed left-0 top-0 w-screen h-screen flex justify-center items-center bg-[rgba(0,0,0,0.6)]'>
            <div className='sm:w-[250px] w-[90%] flex flex-col justify-center items-center bg-gray-200 sm:p-6 p-4 rounded-2xl gap-3'>
                <p className='subtitle'>Deletar tarefa?</p>
                <button
                ...
                <button
                    ...
                    onClick={() => props.setConfirmDelete(false)}
                >
                    Cancelar
                </button>
            </div>
